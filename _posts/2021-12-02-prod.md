...
To evaluate the effect of a given recommender algorithm on echo chambers and polarization using PROD, we have proposed the following evaluation methodology:
   ...
   6. Assess the average difference _∆m_ between the two cases. Since the initial measure _m(G)_ is the same with and without recommender, we obtain <img src="https://render.githubusercontent.com/render/math?math=%5CDelta%20m%20%3D%20%5Cfrac%7B1%7D%7BK%7D%20%5Csum_%7BG%20%5Cin%20G_%7B%5Cmu%2C%5Ceta%7D%7D%20m(G%5E%27_l)%20%5C-%20m(G%5E%27_0)%0A">.
